  ...
  return (
    <Card className="flex flex-col justify-between hover:border-slate-700 transition-all group">
      ...
      <CardContent className="p-5 py-3 space-y-2 text-xs text-slate-300 border-t border-b border-slate-800/60 my-2">
        {proposal.content && (
          <p className="text-xs text-slate-400 line-clamp-3 bg-slate-950/60 p-3 rounded-xl border border-slate-800/50 leading-relaxed">
            {proposal.content}
          </p>
        )}
      ...
      <CardFooter className="p-5 pt-2 flex items-center justify-between">
        {!proposal.convertedToId ? (
          <Button
            ...
            className="p-0 h-auto text-xs text-purple-400 hover:text-purple-300 font-semibold flex items-center gap-1.5"
          >
        ...
        <AlertDialog open={deleteOpen} onOpenChange={setDeleteOpen}>
          ...
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction onClick={handleDelete}>Delete Proposal</AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
        </AlertDialog>
      </CardFooter>
