  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-white tracking-tight">Invoices & Financials</h1>
          <p className="text-xs sm:text-sm text-slate-400 mt-1">Generate client billing, track payments, and review financial metrics</p>
        </div>
      ...
      {metrics && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6 bg-slate-900 border-slate-800 space-y-2">
