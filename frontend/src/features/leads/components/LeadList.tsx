  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-white tracking-tight">Leads & Opportunities</h1>
          <p className="text-xs sm:text-sm text-slate-400 mt-1">Track prospect pipeline stages and convert deals to clients</p>
        </div>
