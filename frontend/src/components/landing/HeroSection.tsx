...
export function HeroSection() {
  return (
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden bg-slate-950">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] sm:w-[900px] h-[400px] bg-gradient-to-tr from-blue-600/20 via-indigo-600/15 to-purple-600/10 blur-[120px] rounded-full pointer-events-none -z-0" />
          ...
          <div className="relative rounded-2xl border border-slate-800/80 bg-slate-900/90 shadow-2xl shadow-blue-950/50 backdrop-blur-2xl overflow-hidden p-2 sm:p-4 group">
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-slate-950/80 rounded-t-xl border-b border-slate-800/80 mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="ml-2 text-xs font-mono text-slate-500">freelanceflow.app/dashboard</span>
              </div>
            ...
            <div className="p-4 sm:p-6 bg-slate-950/50 rounded-xl space-y-6 text-left">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-4 space-y-2">
                  ...
                  <div className="text-xl sm:text-2xl font-bold text-white">$14,850.00</div>
                ...
                <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-4 space-y-2">
                  ...
                  <div className="text-xl sm:text-2xl font-bold text-white">12 Clients</div>
                  <div className="text-xs text-slate-400">4 retainers active</div>
                </div>
                ...
                <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-4 space-y-2">
                  ...
                  <div className="text-xl sm:text-2xl font-bold text-white">8 Projects</div>
                  <div className="text-xs text-slate-400">92% on schedule</div>
                </div>
                ...
                <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-4 space-y-2">
                  ...
                  <div className="text-xl sm:text-2xl font-bold text-white">98.4%</div>
                  <div className="text-xs text-emerald-400 font-medium">Avg payout 1.2 days</div>
                </div>
              </div>
                  ...
                  <div className="h-44 flex items-end justify-between gap-2 sm:gap-4 pt-4 border-b border-slate-800/80 pb-2">
                    {[
                      ...
                      <div key={item.month} className="flex-1 flex flex-col items-center gap-2 h-full justify-end group/bar">
                        <span className="text-[10px] font-mono text-slate-400 opacity-0 group-hover/bar:opacity-100 transition-opacity">
                          {item.amount}
                        </span>
                        <div
                        ...
                        />
                        <span className={`text-xs ${item.active ? "text-blue-400 font-bold" : "text-slate-500"}`}>
                          {item.month}
                        </span>
                      </div>
                    ))}
                    ...
                    {[
                      ...
                      <div key={idx} className="flex items-center justify-between p-3 rounded-lg bg-slate-950/60 border border-slate-800/80 text-xs">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-[11px] text-slate-400">{task.client}</p>
                        </div>
