...
export function AboutSection() {
  return (
    <section className="py-20 sm:py-28 bg-slate-50 dark:bg-slate-950 relative overflow-hidden border-t border-slate-200 dark:border-slate-800/80 transition-colors duration-200" id="about">
      {/* Glow Effects */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          ...
          <div className="bg-white/80 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 hover:border-slate-300 dark:hover:border-slate-700 rounded-2xl p-8 backdrop-blur-md transition-all duration-300 hover:-translate-y-1 group flex flex-col justify-between h-full shadow-lg shadow-slate-200/50 dark:shadow-none">
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-xl bg-blue-500/10 border border-blue-500/20 text-blue-600 dark:text-blue-400 flex items-center justify-center font-bold shadow-lg shadow-blue-500/10 group-hover:scale-110 transition-transform">
            ...
            <ul className="space-y-2.5 pt-6 mt-6 border-t border-slate-200 dark:border-slate-800/60 text-xs text-slate-700 dark:text-slate-300 font-medium">
          ...
          <div className="bg-white/80 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 hover:border-slate-300 dark:hover:border-slate-700 rounded-2xl p-8 backdrop-blur-md transition-all duration-300 hover:-translate-y-1 group flex flex-col justify-between h-full shadow-lg shadow-slate-200/50 dark:shadow-none">
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-xl bg-indigo-500/10 border border-indigo-500/20 text-indigo-600 dark:text-indigo-400 flex items-center justify-center font-bold shadow-lg shadow-indigo-500/10 group-hover:scale-110 transition-transform">
          ...
          <div className="bg-white/80 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 hover:border-slate-300 dark:hover:border-slate-700 rounded-2xl p-8 backdrop-blur-md transition-all duration-300 hover:-translate-y-1 group flex flex-col justify-between h-full shadow-lg shadow-slate-200/50 dark:shadow-none">
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-xl bg-purple-500/10 border border-purple-500/20 text-purple-600 dark:text-purple-400 flex items-center justify-center font-bold shadow-lg shadow-purple-500/10 group-hover:scale-110 transition-transform">
