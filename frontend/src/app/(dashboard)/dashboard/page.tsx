  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="bg-white dark:bg-slate-900/80 border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-100 shadow-sm dark:shadow-none">
          ...
          <CardContent className="space-y-1">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">Primary Workspace</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white dark:bg-slate-900/80 border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-100 shadow-sm dark:shadow-none">
          ...
          <CardContent className="space-y-1">
            <h3 className="text-lg font-bold text-slate-900 dark:text-white">{user?.role}</h3>
      ...
      <div className="space-y-4 pt-2">
        <h2 className="text-xl font-bold tracking-tight text-slate-900 dark:text-white">CRM Workspace Modules</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {modules.map((m) => {
            const Icon = m.icon;
            return (
              <Link key={m.title} href={m.href} className="group">
                <Card className="h-full bg-white dark:bg-slate-900/90 border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 transition-all flex flex-col justify-between shadow-sm dark:shadow-none">
                  <CardHeader className="space-y-3">
                    ...
                    <CardDescription className="text-slate-600 dark:text-slate-400 text-xs">{m.desc}</CardDescription>
                  </CardHeader>
